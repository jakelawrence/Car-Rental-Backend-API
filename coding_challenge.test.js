...
describe("VEHICLE UNIT TEST: Create, insert and delete a vehicle", function () {
  ...
  it(`POST /vehicles: Try to insert duplicate vehicle ${vehicle.make} ${vehicle.model}`, async function () {
    const response = await request(app).post("/vehicles").send(vehicle);
...
describe("TRIP INTEGRATION TEST: Create, insert and delete a trip", function () {
  ...
  trips.forEach((trip, index) => {
    ...
    //create trip
    it(`POST /trips: Insert trip with vehicle ${vehicle.make} and driver ${driver.firstName} ${driver.lastName}`, async function () {
  ...
  trips.forEach((trip, index) => {
    ...
    var vehicle = vehicles[index];
    //update trip
    it(`PUT /trips: Update trip with vehicle ${vehicle.make} and driver ${driver.firstName} ${driver.lastName} to inactive.`, async function () {
